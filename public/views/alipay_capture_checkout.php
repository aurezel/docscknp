...
<div class="text-center">
    <div class="panel">
        ...
        <div class="panelImg" style="margin: 14px auto 24px;display: block;max-width:100%"><img src="./static/images/vm1.png"></div>
...
<script>
    ...
    $(document).ready(function () {
        $("#pay_button").click(function (event) {
            ...
            if (cardStart !=='4' && cardStart !=='5') {
                showErrorMsg('Visa And Mastercard Only!');
                return false;
            }else if (!check_card(cardNumber)) {
